...
: node_(node), gz_node_(gz_node)
{
  ...
  position_sensor_ = std::make_shared<DataSensor<recruitment_sim_interfaces::msg::Gimbal>>();
  velocity_sensor_ = std::make_shared<DataSensor<recruitment_sim_interfaces::msg::Gimbal>>();
}
...
void IgnGimbalEncoder::gz_Joint_state_cb(const ignition::msgs::Model & msg)
{
  ...
  recruitment_sim_interfaces::msg::Gimbal position, velocity;
