...
: node_(node), chassis_actuator_(chassis_actuator), gimbal_encoder_(gimbal_encoder)
{
  ...
  ros_chassis_cmd_sub_ = node_->create_subscription<recruitment_sim_interfaces::msg::ChassisCmd>(
...
void ChassisController::chassis_cb(const recruitment_sim_interfaces::msg::ChassisCmd::SharedPtr msg)
{
