...
#include "recruitment_sim_interfaces/msg/chassis_cmd.hpp"
...
public:
  ChassisController(
    ...
    Sensor<recruitment_sim_interfaces::msg::Gimbal>::SharedPtr gimbal_encoder,
...
private:
  void chassis_cb(const recruitment_sim_interfaces::msg::ChassisCmd::SharedPtr msg);
  void cmd_vel_cb(const geometry_msgs::msg::Twist::SharedPtr msg);
  void update();

private:
  rclcpp::Node::SharedPtr node_;
  rclcpp::Subscription<recruitment_sim_interfaces::msg::ChassisCmd>::SharedPtr ros_chassis_cmd_sub_;
  ...
  Sensor<recruitment_sim_interfaces::msg::Gimbal>::SharedPtr gimbal_encoder_;
  // target data
  double target_vx_{0};
  double target_vy_{0};
  double target_w_{0};
