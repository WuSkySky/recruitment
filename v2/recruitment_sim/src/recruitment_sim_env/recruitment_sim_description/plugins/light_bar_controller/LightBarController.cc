...
struct VisualEntityInfo {
    Entity entity;
    explicit VisualEntityInfo(Entity _entity)
        : entity(_entity)
    {
    }
};
...
public:
    ...
    void UpdateVisualEntities(ignition::gazebo::EntityComponentManager &_ecm);
                             ...
                             ignition::gazebo::EntityComponentManager &_ecm)
{
    ...
    }
    {
        ...
        if(this->dataPtr->change){
            this->dataPtr->UpdateVisualEntities(_ecm);
...
void LightBarControllerPrivate::UpdateVisualEntities(
    ignition::gazebo::EntityComponentManager &_ecm)
{
